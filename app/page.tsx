    ...
    <>
      <div className="main-bg lg:h-svh">
        <div className="mx-auto mt-40 lg:px-[30px] xl:w-4/5 2xl:w-3/4 xl:px-0 max-w-[1800px]">
          <div className="flex lg:flex-row flex-col justify-between items-center gap-16 lg:gap-10 relative">
            <Image src={idea} alt="idea" priority />
            <h1 className="font-black xl:text-[75px] text-[55px] text-center lg:text-left md:w-2/4 text-black mb-10 lg:mb-0">
              โครงการสำรวจยอดขายรายไตรมาส
            </h1>
            <div className="absolute top-[1rem] lg:top-[1.2rem] lg:left-[4rem]">
              <Button primary onClick={() => executeScroll(objectiveRef)}>
                <h1 className="text-xl">วัตถุประสงค์</h1>
              </Button>
            </div>
            <div className="absolute top-[6rem] lg:-top-2 lg:left-[32rem]">
              <Button primary onClick={() => executeScroll(areaRef)}>
                <h1 className="text-xl">พื้นที่เก็บข้อมูล</h1>
              </Button>
            </div>
            <div className="absolute top-[11rem] lg:top-[4.6rem] lg:left-[31rem]">
              <Button primary onClick={() => executeScroll(benefitRef)}>
                <h1 className="text-xl">ประโยชน์ที่ได้รับ</h1>
              </Button>
            </div>
            <div className="absolute top-[16rem] lg:top-[10.2rem] lg:left-[4rem]">
              <Button primary onClick={() => executeScroll(taskRef)}>
                <h1 className="text-xl">อำนาจหน้าที่</h1>
              </Button>
            </div>
            <div className="absolute top-[21rem] lg:top-[25.9rem] lg:left-[1rem]">
              <Button primary onClick={() => executeScroll(securityRef)}>
                <h1 className="text-xl">การรักษาความลับ</h1>
              </Button>
            </div>
          </div>
        </div>
